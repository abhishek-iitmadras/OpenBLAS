...
if (DYNAMIC_ARCH)
  if (ARM64)
    ...
    if (${CMAKE_C_COMPILER_ID} STREQUAL "GNU")
      ...
      if (${CMAKE_C_COMPILER_VERSION} VERSION_GREATER_EQUAL 12) # SVE2 ACLE in GCC >= 12
        set(DYNAMIC_CORE ${DYNAMIC_CORE} ARMV9SVE)
      endif ()
    ...
    elseif (${CMAKE_C_COMPILER_ID} MATCHES "Clang")
      ...
      if (${CMAKE_C_COMPILER_VERSION} VERSION_GREATER_EQUAL 13) # SVE2 ACLE in LLVM/Clang >= 13
        set(DYNAMIC_CORE ${DYNAMIC_CORE} ARMV9SVE)
      endif ()
